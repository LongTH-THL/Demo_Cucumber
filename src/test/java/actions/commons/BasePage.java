...
public class BasePage {
        ...
        public static actions.commons.BasePage getBasePageObject() {
            return new actions.commons.BasePage();
        }
...
//            System.out.println("Element is in DOM and visible");
        ...
        private Duration longTimeout = Duration.ofSeconds(GlobalContains.LONG_TIMEOUT);
        private Duration shortTimeout = Duration.ofSeconds(GlobalContains.SHORT_TIMEOUT);
    }
